/**
 * Styles applied to CodebookMD markdown cells so they look like the VS Code
 * Markdown Preview (extensions/markdown-language-features/media/markdown.css)
 * instead of the notebook renderer's more minimal defaults.
 *
 ...
 */
export const markdownCellStyles = `
